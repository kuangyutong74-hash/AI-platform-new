...
function showCurrentPageGuide(){
  ...
  startVoiceInput(){
    ...
    let finalText='';let started=false;let timedOut=false;let timeout=setTimeout(()=>{timedOut=true;try{recognition.abort()}catch(_){ }this.setVoiceStatus('\u9ea6\u514b\u98ce\u542f\u52a8\u8d85\u65f6\uff0c\u8bf7\u68c0\u67e5\u5730\u5740\u680f\u5de6\u4fa7\u7684\u9ea6\u514b\u98ce\u6743\u9650\u3002');},5000);
    this.setVoiceStatus('\ud83c\udf99\ufe0f \u6b63\u5728\u542f\u52a8\u9ea6\u514b\u98ce\u2026\u2026');if(this.$mentorVoiceBtn){this.$mentorVoiceBtn.classList.add('recording');this.$mentorVoiceBtn.setAttribute('aria-pressed','true');}
    recognition.onstart=()=>{started=true;clearTimeout(timeout);timeout=setTimeout(()=>{try{recognition.stop()}catch(_){ }},15000);this.setVoiceStatus('\ud83c\udf99\ufe0f \u6b63\u5728\u542c\u4f60\u8bf4\u2026\u2026\u8bf7\u6e05\u695a\u5730\u8bf4\u51fa\u4f60\u7684\u60f3\u6cd5\u3002');};
    recognition.onresult=(event)=>{let interim='';for(let i=event.resultIndex;i<event.results.length;i++){const text=event.results[i][0].transcript;if(event.results[i].isFinal)finalText+=text;else interim+=text;}const visible=(finalText||interim).trim();if(visible)answer.value=visible;this.setVoiceStatus(finalText?'\u5df2\u8bc6\u522b\uff1a'+finalText:'\u6b63\u5728\u8bc6\u522b\uff1a'+interim);};
    recognition.onerror=(event)=>{clearTimeout(timeout);if(timedOut)return;const messages={'not-allowed':'\u9ea6\u514b\u98ce\u6743\u9650\u672a\u5f00\u542f\uff0c\u8bf7\u5728\u5730\u5740\u680f\u5de6\u4fa7\u5141\u8bb8\u540e\u91cd\u8bd5\u3002','service-not-allowed':'\u6d4f\u89c8\u5668\u7981\u6b62\u4e86\u8bed\u97f3\u8bc6\u522b\uff0c\u8bf7\u68c0\u67e5\u7f51\u7ad9\u6743\u9650\u3002','no-speech':'\u6ca1\u6709\u542c\u5230\u58f0\u97f3\uff0c\u8bf7\u9760\u8fd1\u9ea6\u514b\u98ce\u540e\u91cd\u8bd5\u3002','network':'\u8bed\u97f3\u8bc6\u522b\u670d\u52a1\u8fde\u63a5\u5931\u8d25\uff0c\u8bf7\u68c0\u67e5\u7f51\u7edc\u6216\u76f4\u63a5\u6253\u5b57\u3002'};this.setVoiceStatus(messages[event.error]||'\u8bed\u97f3\u8bc6\u522b\u6ca1\u6709\u6210\u529f\uff0c\u8bf7\u91cd\u8bd5\u6216\u76f4\u63a5\u6253\u5b57\u3002');};
    recognition.onend=()=>{clearTimeout(timeout);this.isRecording=false;this.voiceRecognition=null;if(this.$mentorVoiceBtn){this.$mentorVoiceBtn.classList.remove('recording');this.$mentorVoiceBtn.setAttribute('aria-pressed','false');}if(started&&answer.value.trim()&&!finalText)this.setVoiceStatus('\u8bed\u97f3\u8f93\u5165\u5df2\u505c\u6b62\uff0c\u8bf7\u68c0\u67e5\u6587\u5b57\u540e\u63d0\u4ea4\u3002');};
    try{recognition.start()}catch(_){clearTimeout(timeout);this.isRecording=false;this.voiceRecognition=null;if(this.$mentorVoiceBtn){this.$mentorVoiceBtn.classList.remove('recording');this.$mentorVoiceBtn.setAttribute('aria-pressed','false');}this.setVoiceStatus('\u9ea6\u514b\u98ce\u542f\u52a8\u5931\u8d25\uff0c\u8bf7\u5237\u65b0\u9875\u9762\u540e\u91cd\u8bd5\u3002');}
  }
  renderScene(){
