...
隐私与内容判断：真实姓名、具体学校/班级、详细住址、电话、联系方式、账号密码和验证码不得作为证据，也不得出现在 quote 或 analysis 中；年龄和所在省、市可以正常评价。语言请结合完整语境宽松判断，正常的冒险、冲突、悬念、反派、负面情绪和口语表达可以作为创作证据，不要因“打、炸、死、刀、血、恐怖”等单字机械排除。只有确实露骨、细节化伤害、鼓励现实危险或持续攻击现实人物的部分不计入评价。
