@{
  Services = @(
    ...
    @{ Name='聊天观察'; Port=3000; WorkingDirectory='modules\chat'; Command='node'; Arguments=@('app.js'); Url='http://localhost:3000/home.html?from=ai-bole' },
    ...
    @{ Name='深海基地前端'; Port=3001; WorkingDirectory='modules\deep-sea'; Command='npm'; Arguments=@('run','preview','--','--host','127.0.0.1','--strictPort','--port','3001'); Url='http://localhost:3001/?from=ai-bole' },
